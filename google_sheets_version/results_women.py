...
def collectEventResults():
	...
	sh = gc.open_by_url('https://docs.google.com/spreadsheets/d/1nsczu40IwUKjL1XVffP-UlK5OgW43r-1HMscNVAo92U/edit#gid=2056749980')
...
def publishResults(results_list,event):
	...
	gc = gspread.Client(auth=scoped_credentials)
	gc.session = AuthorizedSession(scoped_credentials)
	sh = gc.open_by_url('https://docs.google.com/spreadsheets/d/1Vo9An8N9T1P8Tx4vyEYWO9yxy2NQ8PFyZuYKZVxKAb8/edit#gid=0')
